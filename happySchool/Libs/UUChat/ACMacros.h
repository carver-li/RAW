...
#define DULog( s, ... ) NSLog( @"< %@:(%d) > %@", [[NSString stringWithUTF8String:__FILE__] lastPathComponent], __LINE__, [NSString stringWithFormat:(s), ##__VA_ARGS__] )
...
#define Main_Screen_Height_Without_NavigationBar      [[UIScreen mainScreen] bounds].size.height-64.0
