...
- (id)initWithSuperVC:(UIViewController *)superVC
{
    ...
    CGRect frame = CGRectMake(0, Main_Screen_Height_Without_NavigationBar-40, Main_Screen_Width, 40);
...
- (void)cancelRecordVoice:(UIButton *)button
{
    ...
    [UUProgressHUD dismissWithError:NSLocalizedString(@"Cancel", nil)];
}
...
{
    [UUProgressHUD changeSubTitle:@"手指上滑 取消"];
}
...
- (void)failRecord
{
    [UUProgressHUD dismissWithSuccess:@"语音太短"];
...
- (void)sendMessage:(UIButton *)sender
{
    ...
    if (self.isAbleToSendTextMessage) {
        ...
        UIActionSheet *actionSheet= [[UIActionSheet alloc] initWithTitle:nil delegate:self cancelButtonTitle:@"Cancel" destructiveButtonTitle:nil otherButtonTitles:@"拍照",@"本地照片",nil];
...
- (void)changeSendBtnWithPhoto:(BOOL)isPhoto
{
    ...
    [self.btnSendMessage setTitle:isPhoto?@"":NSLocalizedString(@"SEND", nil) forState:UIControlStateNormal];
