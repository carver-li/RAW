...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        [self.headImageView addTapGestureRecognizerWithTarget:self action:@selector(btnHeadImageClick:)];
        [headImageBackView addSubview:self.headImageView];
...
- (void)setMessageFrame:(UUMessageFrame *)messageFrame{
    ...
    self.headImageView.frame = CGRectMake(2, 2, ChatIconWH-4, ChatIconWH-4);
    [self.headImageView sd_setImageWithURL:[NSURL URLWithString:message.strIcon] placeholderImage:[UIImage imageNamed:@"headImage.jpeg"]];
    ...
    switch (message.type) {
        ...
        case UUMessageTypePicture:
        {
            ...
            else if (message.pictureUrl) {
                [self.btnContent.backImageView sd_setImageWithURL:message.pictureUrl placeholderImage:[UIImage imageNamed:@"icon_default"]];
            }
...
- (void)loadVoiceData:(NSURL *)voiceUrl {
