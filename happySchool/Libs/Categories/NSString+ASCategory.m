...
- (CGFloat)heightWithFont:(UIFont *)font constrainedToWidth:(CGFloat)width
{
    ...
    if ([[[UIDevice currentDevice] systemVersion] floatValue] >= 7.0) {
        size = [self boundingRectWithSize:constraint options:(NSStringDrawingUsesFontLeading | NSStringDrawingTruncatesLastVisibleLine | NSStringDrawingUsesLineFragmentOrigin) attributes:@{NSFontAttributeName:font} context:NULL].size;
    }
...
- (CGFloat)widthWithFont:(UIFont *)font constrainedToHeight:(CGFloat)height{
    ...
    CGSize size = [self boundingRectWithSize:constraint options:(NSStringDrawingUsesFontLeading | NSStringDrawingTruncatesLastVisibleLine | NSStringDrawingUsesLineFragmentOrigin) attributes:@{NSFontAttributeName:font} context:NULL].size;
...
- (BOOL)isNilOrEmpty
{
    if (!self || [self isKindOfClass:[NSNull class]] || [self isEqualToString:@""] || [self.description isEqualToString:@""]) {
        return YES;
    }
