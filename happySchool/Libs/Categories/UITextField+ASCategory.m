...
- (void)setTextFieldDeleteButtonStyle {
    UIImage *deleteIconNormal = [UIImage imageNamed:@"textField_delete_normal"];
    UIImage *deleteIconSelected = [UIImage imageNamed:@"textField_delete_selected"];
    
    UIButton *clearButton = [self valueForKey:@"_clearButton"];
    [clearButton setImage:deleteIconNormal forState:UIControlStateNormal];
    [clearButton setImage:deleteIconSelected forState:UIControlStateHighlighted];
}
