...
- (UIView *)viewForMessage:(NSString *)message title:(NSString *)title image:(UIImage *)image {
    ...
    if (title != nil) {
        ...
        CGSize expectedSizeTitle = MULTILINE_TEXTSIZE(title, titleLabel.font, maxSizeTitle, titleLabel.lineBreakMode);
    ...
    if (message != nil) {
        ...
        CGSize expectedSizeMessage = MULTILINE_TEXTSIZE(message, messageLabel.font, maxSizeMessage, messageLabel.lineBreakMode);
